...
def ዳታቤዙን_አዘምን():
    ...
    ዋና_ቦታዎች = [
        ...
        ("እንጦጦ", "አዲስ አበባ ከመቆርቆሯ በፊት የዳግማዊ ምኒልክ መቀመጫ የነበረች Ped፣ አሁን ታላቅ የፓርክና የመዝናኛ ስፍራ::", "5 ኮከብ", "🏛 ታሪካዊ እና የመዝናኛ ስፍራዎች"),
    ...
    for ስም, ታሪክ, ደረጃ, ምድብ in ዋና_ቦታዎች:
        የተቀየረ_ስም = ስም.replace(" ", "+")
        ዲፎልት_ካርታ = f"[https://maps.google.com/maps?q=](https://maps.google.com/maps?q=){የተቀየረ_ስም}+Addis+Ababa&t=&z=14&ie=UTF8&iwloc=&output=embed"
        ጠቋሚ.execute("INSERT OR IGNORE INTO ቦታዎች (ስም, ታሪክ, ደረጃ, ምድብ, ካርታ) VALUES (?, ?, ?, ?, ?)", 
                       (ስም, ታሪክ, ደረጃ, ምድብ, ዲፎልት_ካርታ))
        
        if "ታሪካዊ" in ምድብ: ፎቶ_ናሙና = "[https://images.unsplash.com/photo-1549488344-1f9b8d2bd1f3](https://images.unsplash.com/photo-1549488344-1f9b8d2bd1f3)"
        elif "ንግድ" in ምድብ: ፎቶ_ናሙና = "[https://images.unsplash.com/photo-1555529669-e69e7aa0ba9a](https://images.unsplash.com/photo-1555529669-e69e7aa0ba9a)"
        elif "ትራንስፖርት" in ምድብ: ፎቶ_ናሙና = "[https://images.unsplash.com/photo-1544620347-c4fd4a3d5957](https://images.unsplash.com/photo-1544620347-c4fd4a3d5957)"
